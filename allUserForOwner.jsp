...
<body>
 ...
 <!--Header-part-->
  <div id="header">
    <h1>
      <a href="allUserForOwner.jsp">L.I.C.</a>
    </h1>
  </div>
  <!--close-Header-part-->
  ...
  <div id="sidebar">
    <a href="#" class="visible-phone">
      ...
      <ul>
        <li  class="active "> <a href="allUserForOwner.jsp "><i class="icon-group "></i> <span>รายชื่อพนักงาน</span></a> </li>
        <li> <a href="editforOwner.jsp "><i  class="icon-pencil "></i> <span>แก้ไขข้อมูลพนักงาน</span></a> </li>
        <li><a href="addHR.jsp "><i class="icon icon-th "></i> <span>เพิ่ม HR user</span></a></li>
        <li><a href="scoreforOwner.jsp "><i class="icon icon-fullscreen "></i> <span>ให้คะแนนพนักงานที่ลาออก</span></a></li>
        <li><a href="submitscoreforOwner.jsp "><i class="icon icon-fullscreen "></i> <span>ยืนยันคะแนนพนักงานที่ลาออก</span></a></li>
        <li><a href="resume.jsp"><i class="icon-picture "></i> <span>ประวัติการทำงานของพนักงาน</span></a></li>
