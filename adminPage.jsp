...
<!--Header-part-->
<div id="header">
  <h1><a href="adminPage.jsp">L.I.C.</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="index.jsp" class="visible-phone"><i class="icon icon-home"></i></a>
  <ul>
    <li class="active"><a href="allCompany.jsp"><i class="icon icon-home"></i> <span>รายชื่อสถานประกอบการ</span></a> </li>
    ...
    <li><a href="gallery.jsp"><i class="icon-picture"></i> <span>Gallery</span></a></li>
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lo span3"> <a href="allCompany.jsp"> <i class="icon-th-list"></i>รายชื่อสถานประกอบการ</a> </li>
        <li class="bg_lg span3"> <a href="allUser.jsp"> <i class="icon-signal"></i>รายชื่อพนักงาน</a> </li>
        <li class="bg_lo span3"> <a href="token.jsp"> <i class="icon-th-list"></i>TOKEN</a> </li>
