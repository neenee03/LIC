...
<!--Header-part-->
  ...
  <div id="sidebar">
    <a href="allUserForHR.jsp" class="visible-phone">
      ...
      <ul>
        ...
        <li  class="active"><a href="scoreforHR.jsp "><i class="icon icon-th "></i> <span>ให้คะแนนพนักงานที่ลาออก</span></a></li>
        <li><a href="checkdataHR.jsp "><i class="icon-picture "></i> <span>check data</span></a></li>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a href="scoreforHR.jsp" class="current">ให้คะแนนพนักงานที่ลาออก</a>
      </div>
