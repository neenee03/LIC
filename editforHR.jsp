  ...
  <div id="sidebar">
    <a href="allUserForHR" class="visible-phone">
      ...
      <ul>
        ...
        <li class="active"> <a href="editforHR.jsp "><i  class="icon-pencil "></i> <span>แก้ไขข้อมูลพนักงาน</span></a> </li>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a href="editforHR.jsp" class="current">แก้ไขข้อมูลพนักงาน</a>
      </div>
