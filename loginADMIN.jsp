...
<body>
 <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="adminPage.jsp">
                    <div class="control-group normal_text"> <h1>L O G I N</h1></div>
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><a type="submit" href="adminPage.jsp" class="btn btn-success" /> Login</a></span>
                </div>
            </form>
