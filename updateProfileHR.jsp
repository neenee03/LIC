...
<!--Header-part-->
  <div id="header">
    <h1>
      <a href="updateProfileHR.jsp">L.I.C.</a>
    </h1>
  </div>
  <!--close-Header-part-->
  ...
  <div id="sidebar">
    <a href="allUserForHR.jsp" class="visible-phone">
      ...
      <ul>
        <li   class="active"> <a href="allUserForHR.jsp "><i class="icon-group "></i> <span>รายชื่อพนักงาน</span></a> </li>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a href="allUserForHR.jsp" class="current">รายชื่อพนักงาน</a>
      </div>
