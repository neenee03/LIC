...
<body>
 ...
 <!--Header-part-->
    <div id="header">
        <h1>
            <a href="submitscoreforOwner.jsp">L.I.C.</a>
        </h1>
    </div>
    <!--close-Header-part-->
    ...
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav">
            <li>
                <a title="" href="allUserForOwner.html">
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">ยืนยันคะแนนพนักงานที่ลาออก</a>
            </div>
        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>รายชื่อพนักงานที่ให้คะแนนแล้ว รอการตรวจสอบ</h5>
            </div>
                ...
                <table class="table table-bordered data-table">
                    ...
                    <tbody>
                        <tr class="gradeX">
                            ...
                            <td class="center">2-7643-76386-29-9</td>
